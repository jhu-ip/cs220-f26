...
3.	Navigate into **cs220-xxx-public**, type `git status` and confirm you have not modified any files or accidentally committed to the public repo. Ask for help if you have added or committed files there and need to undo.
...
3.	Copy the template files to the current directory using: `cp ~/cs220-xxx-public/exercises/ex06/* .`.
...
2.	Read the source code and the comments.  Your instructions are in the comments. You will find it handy to use [this website](https://www.calculatorsoup.com/calculators/financial/compound-interest-calculator-resources.php) for looking up formulas to solve the problem.
