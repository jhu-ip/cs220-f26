...
reference solutions:
  ...
  2. A passed array decays to a pointer. Since components are stored sequentially in memory in row major order, Sizes (except for first dimension) are required to linearize the array index.
