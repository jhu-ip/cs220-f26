...
<li><strong>Due: Fri Sept 18, 11pm (Baltimore time).</strong></li>
</ul>
</div>
</div>
...
we expect your log for this homework to show more activity. (It is ok if it also shows activity from class exercises - do NOT manually edit the generated log file.)
...
here](https://jhucsf.github.io/fall2026/resources/style.html) from a
...
the `diff` in the Testing example above.
...
<div class='content'>
<p>Remember that there is a 12-hour late grace period in which you may submit assignments after the stated deadline. Beyond that it will not be accepted (ie, you will get a 0). 
</p>
</div>
</div>
